...
export const ko = {
  ...
  'robots.detail.rotate.success': '새 credential ID: {id}',
  'robots.detail.rotate.error': '회전 실패',
  'robots.detail.rotate.fingerprint': 'SSH fingerprint',
  'robots.detail.rotate.fingerprintError': 'fingerprint 계산 실패',
  ...
  'robots.form.validation.fleetId': 'Fleet ID는 필수입니다.',
  ...
  'robots.detail.rotate.toast.success': 'credential 갱신 완료',
  'robots.detail.rotate.toast.successDescription': 'SSH host key 재신뢰됨 — 새 credential ID: {id}',
  ...
  'fleets.form.toast.success': 'Fleet 생성 완료',
  'fleets.row.delete.confirm.title': 'Fleet 삭제',
  'fleets.row.delete.confirm.description': '이 fleet과 관련 정책이 영구히 제거됩니다. 소속 로봇은 함께 삭제되지 않습니다.',
  'fleets.row.delete.confirm.typingHint': 'fleet 이름을 정확히 입력해야 삭제됩니다.',
  'fleets.row.delete.toast.success': 'Fleet이 삭제되었습니다',
  'fleets.row.update.toast.success': 'Fleet이 수정되었습니다',
  'fleets.empty.cta': '첫 fleet 생성',
  'fleets.action.create': 'Fleet 생성',
  ...
  'sso.error.disabled':
    '본 기능은 enterprise 라이선스에서만 활성화됩니다 (Settings > 라이선스).',
  // RBAC fleet 정밀화 Stage 5 — Group → Role 매핑 (provider 상세).
  ...
  'sso.groupmap.form.group.placeholder': '예: fleet-admin-warehouse-a',
  'sso.groupmap.form.role': '역할 ID',
  'sso.groupmap.form.role.placeholder': '예: rol_<ULID>',
  'sso.groupmap.form.scope.tenant': 'Tenant 전체',
  'sso.groupmap.form.scope.fleet': '특정 Fleet',
