...
- **전체 시스템 설계서**: [`docs/design/`](./docs/design/) 13개 마크다운 + [`docs/design/notes/`](./docs/design/notes/) 24개 deepdive (Phase 5 carryover scanrun SSH·세분 RBAC·PWA 3종 design doc + 각 Stage 1 코드 진입)
