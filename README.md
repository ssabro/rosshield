...
- **전체 시스템 설계서**: [`docs/design/`](./docs/design/) 13개 마크다운 + [`docs/design/notes/`](./docs/design/notes/) 27개 deepdive (Phase 5 핵심 3 epic 마감 + 후속 3 design doc — scanrun extras·RBAC fleet 정밀화·PWA persist)
