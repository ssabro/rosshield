...
- **전체 시스템 설계서**: [`docs/design/`](./docs/design/) 13개 마크다운 + [`docs/design/notes/`](./docs/design/notes/) 30개 deepdive (Phase 5 + Phase 6 후보 1 마감 + marathon retrospective — enterprise PoC partner 모집 baseline 완성)
