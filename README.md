...
- **전체 시스템 설계서**: [`docs/design/`](./docs/design/) 13개 마크다운 + [`docs/design/notes/`](./docs/design/notes/) 27개 deepdive (Phase 5 — scanrun SSH·세분 RBAC·PWA·**PWA persist 4 epic 마감** + RBAC fleet 정밀화 4/5 진척)
