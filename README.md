...
- **전체 시스템 설계서**: [`docs/design/`](./docs/design/) 13개 마크다운 + [`docs/design/notes/`](./docs/design/notes/) 32개 deepdive (Phase 5·6 마감 + v0.3.0 release + ROS2 pack Round 1 진입 + Phase 7 통합 design — 사용자 결정 trigger 단계 가속)
