...
> **CIS Ubuntu 24.04 자동 변환률**: **92.0%** (287/312, 2026-05-14). nrobotcheck baseline JSON에서 21 합성 패턴 자동 변환 — 기본 9종(PASS 마커 / Nothing returned / stat 권한 / sshd boolean·numeric·range / multi-line cmd 흡수 / hashbang body wrap / grep verify / awk exact match) + 12 영역별(D 6.2.3.x auditctl 19건 / E-1 gsettings·sshd OR·auditd alternation 6건 / E-2 nftables hook+list+iptables 4건 / E-3 dpkg-query·stat 옵트·apparmor 7건 / G16 passwd-group awk 3건 / G14 grub.cfg / G3 nftables include / G10 hashbang emit 2건 / G6 ufw status / G13 sudo timeout / G5 hashbang Audit emit). 잔여 NoMarker 4건 + Manual 21건은 manual fixture 또는 별 epic.
> **탄생일**: 2026-04-23
...
| D7 | 초기 타깃 벤치마크 | ✅ CIS Ubuntu 24.04 (자동 변환 92.0%) + ROS2 Jazzy baseline |
...
#   total: 312, auto-converted: 287 (92.0% auto)
#   degraded: Manual=21, NoMarker=4 (Phase 2 fixture 필요)
...
**잔여 4 NoMarker**: 6.2.3.6 manual fixture / 4.4.2.2 iptables multi-line table / 4.2.4 ufw before.rules + table / 4.4.2.4 narrative open ports vs iptables. Manual에 가까운 항목 또는 별 epic 후속.
