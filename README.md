...
- **전체 시스템 설계서**: [`docs/design/`](./docs/design/) 13개 마크다운 + [`docs/design/notes/`](./docs/design/notes/) 31개 deepdive (Phase 5 + Phase 6 후보 1 + ROS2 pack carryover 마감 — 솔루션 자율 진행 가능 모든 design + code 작업 완전 마감)
