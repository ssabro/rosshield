...
- [~] **D6 — 리포 호스팅**: 2026-05-07 보류 결정. Phase 1 exit 후 public 전환 계획은 보류 — Phase 3 진입 시 D5(라이선스) 결정 후 재논의. 사용자(2026-05-07): "상업적 도구로 만드는데 핵심 기술이 공개되는 게 우려됨". P1(외부 검증 가능성)은 public 없이도 "감사인이 빌드 검증 가능한 결정론적 결과 + 검증된 contributor에게 read 권한 부여"로 대체 가능.
