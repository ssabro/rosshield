...
- [x] **D5 — 라이선스 모델**: **Open-core** · 2026-04-23. 코어(감사 엔진·CLI·팩 포맷)는 Apache-2.0, 엔터프라이즈(SSO·멀티테넌트 관리·클라우드 대시보드)는 closed. 근거: P1 외부 검증 가능성 + 상용 차별화.
- [x] **D6 — 리포 호스팅**: **GitHub private → Phase 1 exit 후 public** · 2026-04-23.
