...
- [~] **D1 — 제품명 확정**: 부분 확정(2026-04-23). 코드 네임스페이스 `rosshield` 확정(Google 검색으로 무충돌 검증). 제품 브랜드는 `<ProductName>` placeholder로 유지 → Phase 1 후반 최종 확정. 초기 가칭 "FleetGuard"는 Cummins·Attestor.ai 등 상표 충돌로 폐기.
