...
| # | 항목 | 기본 방향 | 참조 |
|---|---|---|---|
| D1 | 제품명·도메인·상표 확정 | FleetGuard (가칭) | `00-*` |
| D2 | 백엔드 언어 | **Go 권장** (TS 유지도 허용) | `11-*` §11.2 |
| D3 | 데스크톱 셸 | **Tauri 2 권장** (Electron fallback) | `11-*` §11.8 |
| D4 | 어플라이언스 OS | **Ubuntu Core** | `11-*` §11.9 |
| D5 | 라이선스 모델 | OSS vs closed vs open-core (결정 필요) | `12-*` |
| D6 | 리포지토리 호스팅 | GitHub (공개) vs 사내 | — |
