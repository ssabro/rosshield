...
| D5 | 라이선스 모델 | 🟡 재검토 (2026-05-07) | **Open-core 골격은 유지**하되 코어 라이선스(Apache-2.0 vs BSL/Elastic License) + 코어/엔터프라이즈 코드 분리 시점은 Phase 3 진입 시 재논의 — 상업 보호 우려 | `12-*`, `phase3-backlog.md` R20 |
| D6 | 리포지토리 호스팅 | 🟡 보류 (2026-05-07) | **GitHub private 유지** — Phase 3 진입 시 D5(라이선스) 결정 후 재논의. AWS/대기업이 OSS를 그대로 SaaS화하는 시장 위험과 P1 외부 검증 가능성의 균형 평가 | `phase3-backlog.md` R20 |
